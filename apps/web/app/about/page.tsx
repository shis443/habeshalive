...
export default function AboutPage() {
  return (
    <StaticPageLayout title="About HabeshaLive">
      <p>
        HabeshaLive is a live-streaming platform built for Ethiopian creators — musicians, gamers, and
        just-chatting hosts streaming to an audience that shares their language and culture.
      </p>
      <h2>How creators actually get paid</h2>
      <p>
        HabeshaLive doesn&apos;t run on advertising. Viewers support creators directly by gifting birr
      ...
      <p>
        ...
        by default. HabeshaLive starts from the other direction: built for this audience and these
        creators first.
      </p>
    </StaticPageLayout>
  );
