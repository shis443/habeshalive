...
export default function AnchorCreatorProgramPage() {
  return (
    <StaticPageLayout title="Anchor Creator Program">
      <p>
        Anchor creators are the small group of streamers Birq builds around directly —
      ...
      <ul>
        ...
        <li>Direct support from the Birq team for stream setup, OBS configuration, and payout
      ...
      <p>
        ...
        existing Birq following to apply — you need an existing audience somewhere and a real
        streaming habit.
      </p>
      <h2>How to apply</h2>
      <p>
